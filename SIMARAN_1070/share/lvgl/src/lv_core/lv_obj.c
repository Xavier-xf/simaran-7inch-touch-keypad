...
#endif
lv_font_t *LV_FONT_SIZE_12 = NULL;
lv_font_t *LV_FONT_SIZE_14 = NULL;
lv_font_t *LV_FONT_SIZE_15 = NULL;
lv_font_t *LV_FONT_SIZE_16 = NULL;
lv_font_t *LV_FONT_SIZE_18 = NULL;
lv_font_t *LV_FONT_SIZE_20 = NULL;
lv_font_t *LV_FONT_SIZE_24 = NULL;
lv_font_t *LV_FONT_SIZE_30 = NULL;
lv_font_t *LV_FONT_SIZE_31 = NULL;
lv_font_t *LV_FONT_SIZE_32 = NULL;
lv_font_t *LV_FONT_SIZE_40 = NULL;
lv_font_t *LV_FONT_SIZE_64 = NULL;
lv_font_t *LV_FONT_SIZE_80 = NULL;
...
void lv_init(void)
{
	...
	lv_ft_font_init(&LV_FONT_SIZE_12, 12);
	lv_ft_font_init(&LV_FONT_SIZE_14, 14);
	lv_ft_font_init(&LV_FONT_SIZE_15, 15);
	lv_ft_font_init(&LV_FONT_SIZE_16, 16);
	lv_ft_font_init(&LV_FONT_SIZE_18, 18);
	lv_ft_font_init(&LV_FONT_SIZE_20, 20);
	lv_ft_font_init(&LV_FONT_SIZE_22, 22);
	lv_ft_font_init(&LV_FONT_SIZE_24, 24);
	lv_ft_font_init(&LV_FONT_SIZE_30, 30);
	lv_ft_font_init(&LV_FONT_SIZE_31, 31);
	lv_ft_font_init(&LV_FONT_SIZE_32, 32);
	lv_ft_font_init(&LV_FONT_SIZE_40, 40);
	lv_ft_font_init(&LV_FONT_SIZE_64, 64);
	lv_ft_font_init(&LV_FONT_SIZE_80, 80);
	lv_ft_font_init(&LV_FONT_SIZE_120, 120);
	lv_ft_font_init(&LV_FONT_SIZE_150, 150);
...
{
	extern void lv_ft_font_destroy(lv_font_t * font);
	lv_ft_font_destroy(LV_FONT_SIZE_12);
	lv_ft_font_destroy(LV_FONT_SIZE_14);
	lv_ft_font_destroy(LV_FONT_SIZE_15);
	lv_ft_font_destroy(LV_FONT_SIZE_16);
	lv_ft_font_destroy(LV_FONT_SIZE_18);
	lv_ft_font_destroy(LV_FONT_SIZE_20);
	lv_ft_font_destroy(LV_FONT_SIZE_22);
	lv_ft_font_destroy(LV_FONT_SIZE_24);
	lv_ft_font_destroy(LV_FONT_SIZE_30);
	lv_ft_font_destroy(LV_FONT_SIZE_31);
	lv_ft_font_destroy(LV_FONT_SIZE_32);
	lv_ft_font_destroy(LV_FONT_SIZE_40);
	lv_ft_font_destroy(LV_FONT_SIZE_64);
	lv_ft_font_destroy(LV_FONT_SIZE_80);
	lv_ft_font_destroy(LV_FONT_SIZE_120);
	lv_ft_font_destroy(LV_FONT_SIZE_150);
...
void lv_obj_set_id(lv_obj_t *obj, unsigned int id)
{
	...
	if (parent != NULL)
	{
		...
		{
			LV_LOG_ERROR("lv_obj_set_id: Duplicate ID(%d) setting ", id);
			return;
		}
		obj->obj_id = id;
	}
...
/**
 * @brief 获取对象的ID
 * @param obj 要获取ID的对象指针
 * @return 对象的ID，如果对象为NULL则返回0
 */
unsigned int lv_obj_get_id(lv_obj_t *obj)
{
	...
	if (obj == NULL)
	{
		LV_LOG_WARN("lv_obj_get_id: obj is NULL");
		return 0;
	}
