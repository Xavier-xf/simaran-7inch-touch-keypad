...
typedef INT_T (*FUNC_GETHOSTBYNAME)(IN CONST CHAR_T *domain,OUT UNW_IP_ADDR_T *addr);
...
VOID unw_register_extern_gethostbyname(FUNC_GETHOSTBYNAME func_gethostbyname);
