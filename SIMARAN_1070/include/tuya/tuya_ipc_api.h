...
typedef enum
{
    NOTIFICATION_NAME_MOTION = 0,     			/*动检-门铃1*/         														/* 移动侦测 */
    NOTIFICATION_NAME_DOORBELL = 1,           														/* 门铃按下 */ 
    NOTIFICATION_NAME_DEV_LINK = 2,           														/* IOT设备联动触发 */
    NOTIFICATION_NAME_PASSBY = 3,     			/*门铃呼叫-门铃1*/       													 	/* 正常经过 */  //door1
    NOTIFICATION_NAME_LINGER = 4,             	/*动检-门铃2*/ 													/* 异常逗留 */
    ...
    NOTIFICATION_NAME_HUMAN = 9,              	/*动检-CCTV1*/ 													/* 人形检测 */
    NOTIFICATION_NAME_PCD = 10,               														/* 宠物检测 */
    NOTIFICATION_NAME_CAR = 11,               	/*门铃呼叫-门铃2*/  													/* 车辆检测 */ //door2
    NOTIFICATION_NAME_BABY_CRY = 12,         	 													/* 婴儿哭声 */
    NOTIFICATION_NAME_ABNORMAL_SOUND = 13,    	/*动检-CCTV2*/													/* 声音异响 */
    NOTIFICATION_NAME_FACE = 14,              														/* 人脸检测 */
    NOTIFICATION_NAME_ANTIBREAK = 15,         														/* 强拆告警 */
    NOTIFICATION_NAME_RECORD_ONLY = 16,       														/* 占位，无意义 */
    NOTIFICATION_NAME_IO_ALARM =17,           	/*IO告警-IO/1*/													/* 本地IO设备触发 */
    ...
    NOTIFICATION_NAME_USER_IO = 22,           	/*IO告警-IO/2*/													/* 本地IO设备触发-2 */    
    NOTIFY_TYPE_MAX
}NOTIFICATION_NAME_E;
