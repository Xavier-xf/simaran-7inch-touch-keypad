...
static void wifi_device_info_parsing(char *buffer)
{
	...
	sscanf(buffer, "%s	%d	%d	%s	%s", bssid, &frequency, &scanf_wifi_info[scanf_wifi_cont].db, scanf_wifi_info[scanf_wifi_cont].psk_flags, scanf_wifi_info[scanf_wifi_cont].name);
