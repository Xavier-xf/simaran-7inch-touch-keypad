...
int dac_open(snd_dev dev)
{
	...
	pcm_clk_enable(codec->sddac_gclk);
...
int dac_close(snd_dev dev)
{
	...
	pcm_clk_disable(codec->sddac_gclk);
	pcm_clk_disable(codec->sddachs_clk);
	pcm_clk_disable(codec->sddac_clk);
...
int adc_open(snd_dev dev)
{
	...
	pcm_clk_enable(codec->sdadc_gclk);
...
int adc_close(snd_dev dev)
{
	...
	pcm_clk_disable(codec->sdadc_clk);
	pcm_clk_disable(codec->sdadchs_clk);
	pcm_clk_disable(codec->sdadc_gclk);
